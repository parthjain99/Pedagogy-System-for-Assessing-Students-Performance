            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="categories.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-tags"></span><p>Subjects</p></a></li>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        <div role="tabpanel">
										   ...
										   $sql = "SELECT * FROM tbl_categories WHERE department='$mydepartment'";
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['name']; ?> ?')" <?php print ' href="pages/drop_ct.php?id='.$row['category_id'].'">Drop Subject</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter subject name" name="category" required autocomplete="off">
                                        </div>
										 <div class="form-group">
                                            <label for="exampleInputEmail1">Subject ID</label>
                                            <input type="text" class="form-control" placeholder="Enter subject id" name="category_id" required autocomplete="off">
