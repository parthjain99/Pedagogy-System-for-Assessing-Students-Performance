...
<div class="signup-form">
    <div class="container">
        <form action="studentsignup.php" method="post">
			...
			<div class="form-group">
			<div class="row">
                    <div class="col"><input type="text" class="form-control" name="class" placeholder="Class" required="required"></div>
					<div class="col"><input type="text" class="form-control" name="division" placeholder="Division" required="required"></div>
					<div class="col"><input type="text" class="form-control" name="rollno" placeholder="Roll Number" required="required"></div>
            </div></div>
	<div class="form-group">
                <div class="row">
