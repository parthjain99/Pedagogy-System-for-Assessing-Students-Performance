...
$sql = "SELECT * FROM tbl_examinations WHERE exam_id = '$exam_id' AND  class= '$myclass' AND division ='$mydivision' AND status = 'Active'";
...
$sql = "INSERT INTO tbl_assessment_records (record_id, student_id, student_name, exam_name, exam_id, score, status, next_retake, date, correct_ans)
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                       ...
                                       <form action="pages/submit_assessment.php" method="POST" name="quiz" id="quiz_form" >
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
                                             <p><b>'.$qno.'.</b> '.$qs.'</p>
											 <p><input type="radio" name="an'.$qno.'"  class="form-control" value="'.$op1.'">True</p>
											 <p><input type="radio" name="an'.$qno.'"  class="form-control" value="'.$op2.'">False</p>
											...
											$rte = $_POST['an'.$qno.''];
											echo $rte;
											$sql= "INSERT INTO tbl_check VALUES ('$exam_id ','$qsid','$rte','$myid')";
