...
$sql = "SELECT * FROM tbl_users WHERE class = '$myclass' AND division='$mydivision' AND role='student'";
...
$sql = "SELECT * FROM tbl_examinations WHERE class = '$myclass' AND division='$mydivision' AND status = 'Active'";
$result = $conn->query($sql);
...
$sql = "SELECT * FROM tbl_examinations WHERE class = '$myclass' AND division='$mydivision' AND status = 'Inactive'";
$result = $conn->query($sql);
