            ...
            <div class="page-inner">
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="examinations.php">Practice Quiz</a></li>
                ...
                <div id="main-wrapper">
                    <div class="row col-md-12">
						...
						<div class="col-md-6">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Practice Quiz</h3>
                                </div>
                                <div class="panel-body">
								<?php
								...
								print '
                                 <div class="alert alert-success" role="alert">
                                  You can begin your practice quiz.
                                    </div>

									'; ?>
									<a onclick="return confirm('Are you sure you want to begin ?')" class="btn btn-success" href="quiz.php">Take Quiz</a>
										<?php	
								}
								...
								print '
                                 <div class="alert alert-success" role="alert">
                                  You are good to go.
									...
									'; ?>
									<a onclick="return confirm('Are you sure you want to begin ?')" class="btn btn-success" href="quiz.php">Begin Assessment</a>
