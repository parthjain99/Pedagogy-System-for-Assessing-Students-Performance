        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="practice.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-pencil"></span><p>Practice Quiz</p></a></li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										   ...
										   $sql="SELECT tbl_examinations.*, tbl_categories.* FROM tbl_examinations INNER JOIN tbl_categories ON  tbl_examinations.category = tbl_categories.name where department= '$mydepartment' AND class = '$myclass' AND division='$mydivision'";
			...
			<th>Action</th>
					...
					while($row = $result->fetch_assoc()) {
                                        									   ...
                                        									   $stl = '<a class="btn btn-success" href="practice-quiz.php?id='.$row['exam_id'].'">Practice Quiz</a>';
											                                          print '
										       <tr>
                                                <td>'.$row['exam_name'].'</td>
												<td>'.$row['subject'].'</td>
