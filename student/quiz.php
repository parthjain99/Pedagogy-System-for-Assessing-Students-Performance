            ...
            <div class="horizontal-bar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="practice.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-pencil"></span><p>Practice Quiz</p></a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="./">Home</a></li>
                            <li><a href="examinations.php">Practice</a></li>
                    ...
                    <div class="row">
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                       ...
                                       <form action="pages/submit_quiz.php" method="POST" name="quiz" id="quiz_form" >
...
if ($qno == "1") {
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
                                             <p><b>'.$qno.'.</b> '.$qs.'</p>
											 <p><input type="checkbox" name="an'.$qno.'"  class="form-control" value="'.$op1.'"> '.$op1.'</p>
											 <p><input type="checkbox" name="an'.$qno.'"  class="form-control" value="'.$op2.'"> '.$op2.'</p>
											 <p><input type="checkbox" name="an'.$qno.'"  class="form-control" value="'.$op3.'"> '.$op3.'</p>
											 <p><input type="checkbox" name="an'.$qno.'"  class="form-control" value="'.$op4.'"> '.$op4.'</p>
											 <input type="hidden" name="qst'.$qno.'" value="'.base64_encode($qs).'">
...
if ($qno == "1") {
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
											 ...
											 <p><input type="radio" name="an'.$qno.'"  class="form-control" value="'.$op2.'"> '.$op2.'</p>											 <input type="hidden" name="qst'.$qno.'" value="'.base64_encode($qs).'">
											 <input type="hidden" name="ran'.$qno.'" value="'.base64_encode($enan).'">
                                             </div>
											';	
											}else{
								...
								<br><input onclick="return confirm('Are you sure you want to submit your assessment ?')" class="btn btn-success" type="submit" value="Submit Quiz">
											</form>
                                    </div>
                                </div>  
                    </div>
