...
VALUES ('$user_id', '$first_name', '$last_name', '$gender', '$dob', '$address', '$email', '$phone', '$department', ' ', '$class', '$division', '$rollno')";


if ($conn->query($sql) === TRUE) {

  header("location:otp.php?rp=5114");
} else {

  header("location:signup-student.php?rp=5117");
}
