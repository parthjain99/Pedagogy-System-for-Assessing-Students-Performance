            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>SuperAdmin</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="admin.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-king"></span><p>Admin</p></a></li>

						<li ><a href="teacher.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-user"></span><p>Teacher</p></a></li>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Admin</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Add Admin</a></li>										
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
													<li><a href="edit-admin.php?sid='.$row['user_id'].'">Edit Admin</a></li>
													<li><a href="view-admin.php?sid='.$row['user_id'].'">View Admin</a></li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['first_name']; ?> ?')" <?php print ' href="pages/drop_sd.php?id='.$row['user_id'].'">Drop Admin</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        Nothing was found in database.
                                         ...
                                         <form action="pages/add_admin.php" method="POST">
