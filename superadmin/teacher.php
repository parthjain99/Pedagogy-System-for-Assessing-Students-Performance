                ...
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li ><a href="departments.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-folder-open"></span><p>Departments</p></a></li>
                         ...
                         <li><a href="admin.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-king"></span><p>Admin</p></a></li>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										...
										<div class="form-group">
                                            ...
                                            <select class="form-control" name="department" id='department-list' required>
										...
										<div class="form-group">
                                            ...
                                            <select class="form-control" name="category" id="category-list" required>
