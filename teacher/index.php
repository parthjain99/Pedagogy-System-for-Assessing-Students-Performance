        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="./" class="logo-text"><img src="logo.png" alt="" height="76" width="130"></span></a>
                    </div>
                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
							...
							<li>Department of <?php echo "$mydepartment"; ?></li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "Student Assessment Results"
	},
	data: [{
		type: "pie",
		startAngle: 25,
