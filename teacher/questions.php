...
<head>
		...
		.button1 {background-color: #6666FF;}
		</style>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>Teacher</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="subject.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-file"></span><p>Chapters</p></a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Add Questions</h3>
					<form method="get" action="http://127.0.0.1:5000/" target="_blank">
						<button type="submit" class="button button1">OCR</button>
					</form>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
												...
												<li role="presentation"><a href="#tab7" role="tab" data-toggle="tab">Long Answers</a></li>
												<li role="presentation"><a href="#tab9" role="tab" data-toggle="tab">Multiple Answers</a></li>
												<li role="presentation"><a href="#tab11" role="tab" data-toggle="tab">True And False</a></li>
                                            </ul>
									 ...
									 <button type="submit" class="btn btn-primary">Submit</button>
                                        ...
                                        <button type="submit" class="btn btn-primary">Submit</button>
                                         ...
                                         <form action="pages/add_question2.php?type=La" method="POST">
										 	<div class="form-group">
                                            <label for="exampleInputEmail1">Exam Name</label>
										    <select class="form-control" name="exam" required>
											<option value="" selected disabled>-Select exam</option>
                                            ...
                                            print '<option value="'.$row['exam_id'].'">'.$row['exam_name'].'</option>';
											 ...
											 ?>
												...
												<div class="wrapper">
													<textarea class="form-control" name="answer"  maxlength="300" placeholder="Enter answer"  required autocomplete="off" ></textarea>
													  <div id="the-count">
														<span id="maximum">word limit: 300</span>
													  </div>
													</div>
                                                </div>
                                        ...
                                        <button type="submit" class="btn btn-primary">Submit</button>
                                                ...
                                                <form action="pages/add_question2.php?type=ma" method="POST">
											<div class="form-group">
                                            <label for="exampleInputEmail1">Exam Name</label>
										    <select class="form-control" name="exam" required>
											<option value="" selected disabled>-Select exam</option>
                                      ...
                                      <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="checkbox" name="answer[]" value="option1" ></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" name="answer[]" value="option2" ></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" name="answer[]" value="option3" ></td>
											...
											<tr>
                                                ...
                                                <td><input type="checkbox" name="answer[]" value="option4" ></td>
									 ...
									 <button type="submit" class="btn btn-primary">Submit</button>
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab11">
                                                <form action="pages/add_question2.php?type=tof" method="POST">
											<div class="form-group">
                                            <label for="exampleInputEmail1">Exam Name</label>
										    <select class="form-control" name="exam" required>
											<option value="" selected disabled>-Select exam</option>
