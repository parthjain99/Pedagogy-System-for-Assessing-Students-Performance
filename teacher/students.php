                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter your SAKEC ID" name="student_id" required autocomplete="off">
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Class" name="class" required autocomplete="off">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputEmail1">Division</label>
                                            <input type="text" class="form-control" placeholder="Enter division" name="division" required autocomplete="off">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputEmail1">Roll Number</label>
                                            <input type="number" class="form-control" placeholder="Roll Number" name="rollno" required autocomplete="off">
                                        </div>
										<div class="form-group">
