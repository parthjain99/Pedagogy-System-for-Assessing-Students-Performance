...
<head>
        ...
        <title>OES | Manage Chapters</title>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="subject.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-file"></span><p>Chapters</p></a></li>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Chapters</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Add Chapters</a></li>										
                                      ...
                                      print '
                                        ...
                                        <tbody>';
										   ...
										   $sql = "SELECT * FROM tbl_subjects WHERE category='$out'";
                                           $result = $conn->query($sql);
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['name']; ?> ?')" <?php print ' href="pages/drop_sb.php?id='.$row['subject_id'].'">Drop chapter</a></li>
                                                </ul>
                                            </div></td>
									   ...
									   print '</table>  ';
										...
										<div class="form-group">
                                            ...
                                            print '<option value="'.$out.'">'.$out.'</option>';
                                            }
                                           } else {
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter chapter name" name="subject" required autocomplete="off">
                                        </div>
										
										 <div class="form-group">
                                            <label for="exampleInputEmail1">Chapter ID</label>
                                            <input type="text" class="form-control" placeholder="Enter Chapters id" name="subject_id" required autocomplete="off">
										</div>
