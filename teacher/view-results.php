                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										   ...
										   include '../database/config.php';
											...
											$sql3= "SELECT * FROM tbl_questions WHERE exam_id = '$exam_id'";
										   ...
										   $sql= "SELECT tbl_assessment_records.*, tbl_users.class,tbl_users.division ,tbl_users.rollno FROM tbl_assessment_records INNER JOIN tbl_users ON tbl_assessment_records.student_id = tbl_users.user_id WHERE exam_id = '$exam_id'";
										   $sql2 = "SELECT * FROM tbl_assessment_records WHERE exam_id = '$exam_id'";
                                        ...
                                        <tbody>';
                                          ...
                                          print '
										       <tr>
												...
												<td>'.$row['rollno'].'</td>
												<td>'.$row['correct_ans'].'/'.$total_questions1.'</td> 
                                                <td><b>'.$row['score'].'%</b></td>
												<td>'.$row['status'].'</td>
												<td>'.$row['date'].'</td>
