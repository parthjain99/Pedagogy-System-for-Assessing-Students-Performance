...
if ($result->num_rows > 0) {
	...
	$sdrollno = $row['rollno'];
	$qrcodetxt = 'ID:'.$student_id.', NAME: '.$sdfname.' '.$sdlname.', GENDER: '.$sdgender.', DEPARTMENT : '.$sddepartment.', CLASS : '.$sdclass.', DIVISION : '.$sddivision.', ROLL NUMBER : '.$sdrollno.' ';
						        ...
						        <?php print '<img width="150" src="../assets/qrcode/qr_img.php?d='.$qrcodetxt.'">'; ?>
									...
									<table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="row">4</th>
                                                <td>Class</td>
                                                <td><b><?php echo "$sdclass"; ?></b></td>
                                               
                                            </tr>
																						<tr>
                                                <th scope="row">4</th>
                                                <td>Division</td>
                                                <td><b><?php echo "$sddivision"; ?></b></td>
                                               
                                            </tr>
																						<tr>
                                                <th scope="row">5</th>
                                                <td>Roll Number</td>
                                                <td><b><?php echo "$sdrollno"; ?></b></td>
